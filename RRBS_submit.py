...
class Worker(threading.Thread):
    ...
    def Step2(self):
        ...
        thread = 4 # 4-thread mem should be enough for most analysis. Usually 6GB is enough.
        job_id = Submit_to_hoffman2_array(24, 2048, "Step2.py -i %s --conf %s"%(self.folder, self.conf), lower_index=1, higher_index=len(file_list), interval=1, outputdir=self.folder, thread=thread, messaging="error")
